...
(function (factory) {
    ...
    var BlockUIDirective = (function () {
        ...
        ;
        Object.defineProperty(BlockUIDirective.prototype, "delayStart", {
            set: function (delayStart) { this.delayStart = delayStart; },
            enumerable: true,
            configurable: true
        });
        ;
        Object.defineProperty(BlockUIDirective.prototype, "delayStop", {
            set: function (delayStop) { this.delayStop = delayStop; },
            enumerable: true,
            configurable: true
        });
        ;
            ...
            try {
                ...
                if (parentElement && !this.isComponentInTemplate(parentElement)) {
                    ...
                    if (blockUIContent) {
                        ...
                        if (this.delayStop)
                            this.blockUIComponentRef.instance.templateCmp = this.delayStop;
                    }
                }
            }
            catch (error) {
        ...
        __decorate([
            ...
            __metadata("design:type", Object),
            __metadata("design:paramtypes", [Object])
        ], BlockUIDirective.prototype, "delayStart", null);
        __decorate([
            core_1.Input(),
            __metadata("design:type", Object),
            __metadata("design:paramtypes", [Object])
        ], BlockUIDirective.prototype, "delayStop", null);
