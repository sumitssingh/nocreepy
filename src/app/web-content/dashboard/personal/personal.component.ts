  ...
  constructor(private routers:Router,
    ...
    authService.getUser()
      .subscribe(data => {
        ...
        // for (let j = 0; j <= data.interestedin.length - 1; j++) {
        //   for (let i = 0; i <= this.interestedin.length - 1; i++) {
        //     if (this.interestedin[i].itemName === data.interestedin[j]) {
        //       this.model.interestedin = [
        //         {
        //           'id': this.interestedin[i].id,
        //           'itemName': data.interestedin[j]
        //         }
        //       ]
        //       // break;
        //     }
        //   }
        // }
        // for (let j = 0; j <= data.intent.length - 1; j++) {
        //   for (let i = 0; i <= this.intent.length - 1; i++) {
        //     if (this.intent[i].itemName == data.intent[j]) {
        //       this.model.intent = [
        //         {
        //           'id': this.intent[i].id,
        //           'itemName': data.intent[j]
        //         }
        //       ]
        //       // break;
        //     } else {
        ...
        //     if (this.height[i].itemName === data.height) {
        //       this.model.height = [
        //         {
        //           'id': this.height[i].id,
        //           'itemName': data.height
        //         }
        //       ]
        //       break;
        //     }
        //   }
        // }
        // for (let i = 0; i <= this.bodyType.length - 1; i++) {
        //   if (this.bodyType[i].itemName === data.bodyType) {
        //     this.model.bodyType = [
        //       {
        //         'id': this.bodyType[i].id,
        //         'itemName': data.bodyType
        //       }
        //     ]
        //     break;
        //   }
        // }
        // for (let i = 0; i <= this.doYouOwnACar.length - 1; i++) {
        //   if (this.doYouOwnACar[i].itemName === data.doYouOwnACar) {
        //     this.model.doYouOwnACar = [
        //       {
        //         'id': this.doYouOwnACar[i].id,
        //         'itemName': data.doYouOwnACar
        //       }
        //     ]
        //     break;
        //   }
        // }
        // for (let i = 0; i <= this.education.length - 1; i++) {
        //   if (this.education[i].itemName === data.education) {
        //     this.model.education = [
        //       {
        //         'id': this.education[i].id,
        //         'itemName': data.education
        //       }
        //     ]
        //     break;
        //   }
        // }
        // for (let i = 0; i <= this.educationIn.length - 1; i++) {
        //   if (this.educationIn[i].itemName === data.educationIn) {
        //     this.model.educationIn = [
        //       {
        //         'id': this.educationIn[i].id,
        //         'itemName': data.educationIn
        //       }
        //     ]
        //     break;
        //   }
        // }
        // for (let j = 0; j <= data.language.length - 1; j++) {
        //   for (let i = 0; i <= this.language.length - 1; i++) {
        //     if (this.language[i].itemName === data.language[j]) {
        //       this.model.language = [
        //         {
        //           'id': this.language[i].id,
        //           'itemName': data.language[j]
        //         }
        //       ]
        //     }
        //   }
        // }
        //          for ( let i = 0; i <= this.doYouWantChildren.length - 1; i++) {
        //   if (this.doYouWantChildren[i].itemName === data.doYouWantChildren) {
        //     this.model.doYouWantChildren = [
        //       {
        //         'id': this.doYouWantChildren[i].id,
        //         'itemName': data.doYouWantChildren
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.maritalStatus.length - 1; i++) {
        //   if (this.maritalStatus[i].itemName === data.maritalStatus) {
        //     this.model.maritalStatus = [
        //       {
        //         'id': this.maritalStatus[i].id,
        //         'itemName': data.maritalStatus
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.longestRelationship.length - 1; i++) {
        //   if (this.longestRelationship[i].itemName === data.longestRelationship) {
        //     this.model.longestRelationship = [
        //       {
        //         'id': this.longestRelationship[i].id,
        //         'itemName': data.longestRelationship
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.doYouHaveChildren.length - 1; i++) {
        //   if (this.doYouHaveChildren[i].itemName === data.doYouHaveChildren) {
        //     this.model.doYouHaveChildren = [
        //       {
        //         'id': this.doYouHaveChildren[i].id,
        //         'itemName': data.doYouHaveChildren
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.doYouSmoke.length - 1; i++) {
        //   if (this.doYouSmoke[i].itemName === data.doYouSmoke) {
        //     this.model.doYouSmoke = [
        //       {
        //         'id': this.doYouSmoke[i].id,
        //         'itemName': data.doYouSmoke
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.doYouDrink.length - 1; i++) {
        //   if (this.doYouDrink[i].itemName === data.doYouDrink) {
        //     this.model.doYouDrink = [
        //       {
        //         'id': this.doYouDrink[i].id,
        //         'itemName': data.doYouDrink
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.doYouDoDrugs.length - 1; i++) {
        //   if (this.doYouDoDrugs[i].itemName === data.doYouDoDrugs) {
        //     this.model.doYouDoDrugs = [
        //       {
        //         'id': this.doYouDoDrugs[i].id,
        //         'itemName': data.doYouDoDrugs
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.religion.length - 1; i++) {
        //   if (this.religion[i].itemName === data.religion) {
        //     this.model.religion = [
        //       {
        //         'id': this.religion[i].id,
        //         'itemName': data.religion
        //       }
        //     ]
        //     break;
        //   }
        // }        for ( let i = 0; i <= this.doYouHavePets.length - 1; i++) {
        //   if (this.doYouHavePets[i].itemName === data.doYouHavePets) {
        //     this.model.doYouHavePets = [
        //       {
        //         'id': this.doYouHavePets[i].id,
        //         'itemName': data.doYouHavePets
        //       }
        //     ]
        //     break;
        //   }
        // }for (let j = 0; j <= data.personality.length - 1; j++) {
        //   for (let i = 0; i <= this.personality.length - 1; i++) {
        //     if (this.personality[i].itemName === data.personality[j]) {
        //       this.model.personality = [
        //         {
        //           'id': this.personality[i].id,
        //           'itemName': data.personality[j]
        //         }
        //       ]
        //     }
        //   }
        // }for ( let i = 0; i <= this.ambitious.length - 1; i++) {
        //   if (this.ambitious[i].itemName === data.ambitious) {
        //     this.model.ambitious = [
        //       {
        //         'id': this.ambitious[i].id,
        //         'itemName': data.ambitious
        //       }
        //     ]
        //     break;
        //   }
